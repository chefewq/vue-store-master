    ...
    <div class="block">
      <el-carousel height="460px">
        <el-carousel-item v-for="item in carousel" :key="item.carousel_id">
          <img style="height:460px;" :src="$target + item.lineImg" :alt="item.describes" />
        </el-carousel-item>
      </el-carousel>
    </div>
    <!-- 轮播图END -->
        ...
        <div class="phone">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <router-link to>
                <img :src="$target +'phone/phone.png'" />
              </router-link>
            </div>
            <div class="list">
        ...
        <div class="accessory" id="promo-menu">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <ul>
                <li>
                  <img :src="$target +'accessory/accessory-promo1.png'" alt />
                </li>
                <li>
                  <img :src="$target +'accessory/accessory-promo2.png'" alt />
                </li>
              </ul>
            </div>
            <div class="list">
...
<script>
  import {getHeadline, getPromoProduct} from "../api/goods";
