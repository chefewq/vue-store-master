 ...
 * @LastEditors: ChenHao
 * @LastEditTime: 2020-12-15 17:23 :48
 -->
<template>
  <div id="app" name="app">
    <el-container>
      ...
      <el-footer>
        <div class="footer">
          ...
          <div class="github">
            <a href="https://github.com/chefewq" target="_blank">
...
import {selectShopCarGoodList} from "./api/shopCar";
  ...
  watch: {
    ...
    getUser: function(val) {
      if (val === "") {
        ...
        selectShopCarGoodList({userId: val.userId})
          .then(res => {
            if (res.code === 0) {
              // 001 为成功, 更新vuex购物车状态
              this.setShoppingCart(res.list);
